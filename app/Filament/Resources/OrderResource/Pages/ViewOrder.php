    ...
    public function infolist(Infolist $infolist): Infolist
    {
        return $infolist->schema([
            Section::make('ملخص الفاتورة')->schema([
                ...
                TextEntry::make('total_price')->label('الإجمالي')->money('USD', locale: 'en'),
                TextEntry::make('paid_amount')->label('المدفوع')->money('USD', locale: 'en'),
                TextEntry::make('remaining_amount')->label('المتبقي')->money('USD', locale: 'en'),
                ...
                TextEntry::make('commission_amount')->label('قيمة العمولة')->money('USD', locale: 'en'),
            ])->columns(2),
            ...
            Section::make('عناصر الفاتورة')->schema([RepeatableEntry::make('orderItems')->schema([
                ...
                TextEntry::make('price_at_time')->label('السعر')->money('USD', locale: 'en'),
                TextEntry::make('line_total')->label('الإجمالي')->money('USD', locale: 'en'),
                TextEntry::make('customer_price')->label('سعر البيع للعميل')->money('USD', locale: 'en'),
                TextEntry::make('customer_line_total')->label('إجمالي سعر العميل')->money('USD', locale: 'en'),
            ])->columns(4)]),
            Section::make('سجل الدفعات')->schema([RepeatableEntry::make('payments')->schema([
                TextEntry::make('payment_date')->label('تاريخ الدفع')->date(),
                TextEntry::make('amount')->label('المبلغ')->money('USD', locale: 'en'),
