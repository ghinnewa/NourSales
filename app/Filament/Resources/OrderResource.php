...
class OrderResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('total_price')->label('إجمالي الفاتورة')->money('USD', locale: 'en'),
            Tables\Columns\TextColumn::make('paid_amount')->label('المدفوع')->money('USD', locale: 'en'),
            Tables\Columns\TextColumn::make('remaining_amount')->label('المتبقي')->money('USD', locale: 'en'),
            Tables\Columns\TextColumn::make('status')->label('الحالة')->badge(),
            Tables\Columns\TextColumn::make('commission_amount')->label('العمولة')->money('USD', locale: 'en'),
